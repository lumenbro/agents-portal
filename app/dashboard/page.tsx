...
export default function DashboardPage() {
  ...
  }, [fetchAgents, fetchRecoveryStatus]);
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {hasRecoveryKey !== null && (
        <Card className={`mb-6 ${hasRecoveryKey ? 'bg-gray-900 border-gray-800' : 'bg-orange-900/10 border-orange-900/50'}`}>
          <CardContent className="p-4">
            {recoverySecretDisplay ? (
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <Button
                    ...
                    variant="outline"
                    onClick={() => {
                      navigator.clipboard.writeText(recoverySecretDisplay);
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-500">
                    Backup admin signer is registered on-chain
                  </span>
                </div>
              </div>
            ) : (
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-sm text-orange-400 font-medium">No recovery key set</p>
                  <p className="text-xs text-gray-500 mt-0.5">
                    If you lose your passkey, you won&apos;t be able to access this wallet. Set up a recovery key as a backup.
                  </p>
                </div>
                <Button
                  size="sm"
